...
Model.load(model_name, activation_values=[4 for i in range(4)], min_diff=0.00001, learning_rate=0.000000001, cycles=10, hidden_shaped=False, normaliser_depth=0)
