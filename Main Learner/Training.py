...
Model.load(model_name, activation_values=[4 for i in range(3)], min_diff=0.00001, learning_rate=0.00001, cycles=100, ignore_minimum=1, hidden_shaped=False, normaliser_depth=0)
